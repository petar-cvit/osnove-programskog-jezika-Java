 ...
 * Class creates animation where obserever's position "goes around" scene's objects and takes snapshots.
 * 
...
public class RayCasterParallel2 {
	...
	/**
	 * Main method calls RayTracerViewer's method show with instance of RayTracerProducer and RayTracerAnimator and shows GUI.
	 * 
	 * @param no arguments
	 */
	...
	/**
	 * Creates new implementation of IRayTracerAnimator interface.
	 * 
	 * @return RayTracerAnimator
	 */
